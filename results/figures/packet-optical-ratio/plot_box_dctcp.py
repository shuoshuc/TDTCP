...
for k, v in throughputs.items():
  optval = optimal[k]
  boxes.append(v['dctcp']/optval*100)
...
ax.yaxis.grid(True)
ax.legend([bplot["boxes"][0], bplot["boxes"][1]], ['dctcp', 'tdtcp'],
...
plt.savefig('oe_ratio_dctcp_boxplt.pdf', dpi=200, format='pdf', bbox_inches='tight')
